...
const translations = {
    en: {
        ...
        'about-p1': "I'm a final-year Artificial Intelligence & Data Science Engineering student at the Higher School of Computer Science (<span class=\"highlight\">ESI Sidi Bel Abbès, Algeria</span>), passionate about building intelligent systems that combine research with real-world applications.",
        ...
        'exp-sm-role': 'Social Media & Marketing Manager',
        'exp-sm-brands': 'Various Brands & Scientific Clubs',
        'exp-sm-desc': 'Managed digital presence, shot event content, and edited high-engagement videos for: lashes_by_hayat (aesthetic center), sarah_cosmetique (cosmetics online/in-store), Ingeniums22 (scientific club), Jisr Numuw (national event by Ministry of Youth), ACS 16 (youth minister club), and MySchool University (private school).',
    ...
    fr: {
        ...
        'about-p1': "Je suis un étudiant en dernière année d'ingénierie en Intelligence Artificielle & Data Science à l'École Supérieure en Informatique (<span class=\"highlight\">ESI Sidi Bel Abbès, Algérie</span>), passionné par la création de systèmes intelligents combinant recherche et applications concrètes.",
        ...
        'exp-sm-role': 'Responsable Social Media & Marketing',
        'exp-sm-brands': 'Diverses Marques & Clubs Scientifiques',
        'exp-sm-desc': 'Gestion de la présence en ligne, réalisation de vidéos événementielles et montage vidéo pour : lashes_by_hayat (centre d\'esthétique), sarah_cosmetique (cosmétique en ligne/boutique), Ingeniums22 (club scientifique), Jisr Numuw (événement national du ministère de la Jeunesse), ACS 16 (club du ministère de la Jeunesse), et MySchool University (école privée).',
